...
# => train_retrieval_ms_marco_dataset
# --q_max_len 32 --p_max_len 196 
# => --q_max_len 128 --p_max_len 512 
# --train_n_passages 16
# => --train_n_passages 8 
python examples/repllama/train.py --output_dir model_repllama --model_name_or_path meta-llama/Llama-2-7b-hf --save_steps 10 --dataset_name train_retrieval_ms_marco_dataset --bf16 --per_device_train_batch_size 2 --gradient_accumulation_steps 1 --gradient_checkpointing --train_n_passages 8 --learning_rate 1e-4 --q_max_len 64 --p_max_len 196 --num_train_epochs 1 --logging_steps 10 --overwrite_output_dir --dataset_proc_num 32 --negatives_x_device --warmup_steps 100 > training1.log
