...
python examples/repllama/encode.py --output_dir temp --model_name_or_path model_repllama/checkpoint-10 --tokenizer_name meta-llama/Llama-2-7b-hf --fp16 --per_device_eval_batch_size 4 --q_max_len 64 --p_max_len 196 --dataset_name legal_corpus_retrieval_ms_marco_dataset --encoded_save_path beir_embedding_scifact/corpus_scifact.pkl --encode_num_shard 1 --encode_shard_index 0 > encode.log
