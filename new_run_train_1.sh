...
# meta-llama/Llama-2-7b-hf  
# => tevatron/model_repllama/checkpoint-14200
# python examples/repllama/encode.py --output_dir temp --model_name_or_path model_repllama/checkpoint-5 --tokenizer_name meta-llama/Llama-2-7b-hf --fp16 --per_device_eval_batch_size 4 --q_max_len 32 --p_max_len 196  --dataset_name Tevatron/beir:scifact/test --encoded_save_path beir_embedding_scifact_new/queries_scifact.pkl --encode_is_qry >> encode_q.log
